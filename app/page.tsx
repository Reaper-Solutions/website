    ...
    return (
        <main
            ...
            <Particles
                ...
                quantity={100}
            />
            <h1 className="text-zinc-350 text-4xl text-transparent duration-1000 bg-white cursor-default text-edge-outline animate-title font-display sm:text-6xl md:text-9xl whitespace-nowrap bg-clip-text"
                id="name">
                Reaper Solutions
            </h1>
